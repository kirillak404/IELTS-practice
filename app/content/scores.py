...
SPEAKING_FINAL_FEEDBACK = ("You've just begun your journey in learning English. This is the starting point for everyone, so there's no need to worry! Right now, the goal should be to get comfortable with simple phrases and basic English words. You have a fascinating journey ahead!",
                           "You've taken a step forward in understanding English. You can now use isolated words and phrases. This is a good start! Keep learning and practicing. Soon, you will be able to make simple sentences and communicate more effectively.",
                           "You're making progress! You've started to form short sentences, although with limitations. Keep focusing on basic vocabulary and grammar rules. You are on the right track, and with more practice, your speaking skills will definitely improve.",
                           "Your language skills are developing and you can convey simple messages. It's evident your vocabulary is expanding and your ability to structure sentences is improving. Keep practicing and engaging in conversation to enhance your speaking skills.",
                           "Well done! You can now communicate basic information and express your views on familiar topics. It's time to aim higher – let's focus on having more complex conversations and improving fluency. With dedication and regular practice, you're going to make great strides.",
                           "You're progressing well. You're capable of participating in conversations on familiar topics and your responses are generally clear. Your next target should be to strengthen your fluency, coherence, and pronunciation. With time and practice, you will reach the next level.",
                           "Impressive progress! You can now express opinions and provide detailed answers. Your fluency has improved, and you can use the language flexibly. Now let's work on the accuracy and complexity of your language. It's time to refine your grammar and vocabulary skills.",
                           "You're doing a great job! You have a good grasp of English and can handle a variety of topics with flexibility. Your language use is systematic and effective. The next step is to enrich your vocabulary and work on nuanced expressions to enhance your speaking style.",
                           "Congratulations, you're excelling! You speak English fluently and clearly, which is commendable. However, there's always room for improvement. Work on adding subtlety and depth to your responses. You're almost at the top, keep going!",
                           "Outstanding achievement! You've attained near-native fluency. Your command over English is impressive and you express ideas and opinions precisely and without hesitation. Continue to refine your language skills and expand your vocabulary and grammar knowledge to maintain this level.")